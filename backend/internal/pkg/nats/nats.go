...
var IssueLabelAddedSubject = WorkspaceSubject{subject: "workspaces.%s.issues.label_added"}

// IssueLabelAddedSubjectAll is the wildcard subject for internal consumers.
const IssueLabelAddedSubjectAll = "workspaces.*.issues.label_added"
