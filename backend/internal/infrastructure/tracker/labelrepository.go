...
func (r *LabelRepository) GetOrCreate(ctx context.Context, name string) (label.Label, error) {
...
func (r *LabelRepository) ListByIDs(ctx context.Context, ids []uuid.UUID) ([]label.Label, error) {
	queries := trackerdb.New(r.db)
...
func (r *LabelRepository) SearchByName(ctx context.Context, name string) ([]label.Label, error) {
	queries := trackerdb.New(r.db)
