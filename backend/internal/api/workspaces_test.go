...
func (m *mockWorkspaceService) Create(ctx context.Context, workspace workspacedomain.Workspace) (workspacedomain.Workspace, error) {
...
func Test_CreateWorkspace_ValidBody_Returns201(t *testing.T) {
	...
	service.On("Create", mock.Anything, mock.AnythingOfType("workspace.Workspace")).
...
func Test_CreateWorkspace_ServiceError_ReturnsInternalServerError(t *testing.T) {
	...
	service.On("Create", mock.Anything, mock.AnythingOfType("workspace.Workspace")).
		Return(workspacedomain.Workspace{}, errors.New("db down"))
